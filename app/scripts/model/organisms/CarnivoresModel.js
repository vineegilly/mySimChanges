 ...
 * @constructor
 */
function CarnivoresModel( ecoSystemModel, organismInfo, initialPosition,bounds,createdThroughInteraction ) {
...
inherit( BaseOrganismModel, CarnivoresModel, {
  ...
  clone:function(initialPos,createdThroughInteraction){
    return new CarnivoresModel(this.ecoSystemModel,this.organismInfo,initialPos,this.motionBounds,createdThroughInteraction);
  }
