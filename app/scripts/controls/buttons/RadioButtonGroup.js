define(function (require) {
    ...
    var RadioButtonGroupMember = require('./RadioButtonGroupMember');
    ...
    function RadioButtonGroup(property, contentArray, options) {
        ...
        var defaultOptions = {
          ...
          //  baseColor: ColorConstants.LIGHT_BLUE, Ashraf Commented out
        ...
        var maxWidth = _.max(contentArray, function (content) {
            return content.node.width;
        }).node.width;
        var maxHeight = _.max(contentArray, function (content) {
            return content.node.height;
        }).node.height;
        ...
        for (i = 0; i < contentArray.length; i++) {
            ...
            var radioButton = new RadioButtonGroupMember(property, contentArray[i].value,
                _.extend({
                    ...
                    baseColor: contentArray[i].color || ColorConstants.LIGHT_BLUE
                }, buttonOptions));
